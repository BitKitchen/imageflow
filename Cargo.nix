...
let cratesIO = rec {
  ...
  crates.backtrace."0.3.8" = deps: { features?(features_.backtrace."0.3.8" deps {}) }: buildRustCrate {
    ...
    dependencies = mapFeatures features ([ (crates."cfg_if"."${deps."backtrace"."0.3.8"."cfg_if"}" deps) (crates."rustc_demangle"."${deps."backtrace"."0.3.8"."rustc_demangle"}" deps) ])
      ...
      ++ (if features.backtrace."0.3.8".winapi or false then [ (crates.winapi."0.3.4" deps) ] else [])) else []);
  ...
  features_.imagequant."2.11.9" = deps: f: updateFeatures f (rec {
    ...
    imagequant_sys = fold recursiveUpdate {} [
      ...
      { "2.11.9".openmp =
        (f.imagequant_sys."2.11.9".openmp or false) ||
        (imagequant."2.11.9"."openmp" or false) ||
        (f."imagequant"."2.11.9"."openmp" or false); }
      { "2.11.9".openmp-static =
        (f.imagequant_sys."2.11.9".openmp-static or false) ||
        (imagequant."2.11.9"."openmp-static" or false) ||
        (f."imagequant"."2.11.9"."openmp-static" or false); }
      { "2.11.9".sse =
        (f.imagequant_sys."2.11.9".sse or false) ||
  ...
  crates.imagequant_sys."2.11.9" = deps: { features?(features_.imagequant_sys."2.11.9" deps {}) }: buildRustCrate {
    ...
    buildDependencies = mapFeatures features ([ (crates."cc"."${deps."imagequant_sys"."2.11.9"."cc"}" deps) ]);
    features = mkFeatures (features.imagequant_sys."2.11.9" or {});
  };
  features_.imagequant_sys."2.11.9" = deps: f: updateFeatures f (rec {
    cc = { "${deps.imagequant_sys."2.11.9".cc}".default = true; };
    imagequant_sys = fold recursiveUpdate {} [
      { "2.11.9".default = (f.imagequant_sys."2.11.9".default or true); }
      { "2.11.9".openmp =
        (f.imagequant_sys."2.11.9".openmp or false) ||
        (f.imagequant_sys."2.11.9".openmp-static or false) ||
        (imagequant_sys."2.11.9"."openmp-static" or false); }
      { "2.11.9".openmp-sys =
        (f.imagequant_sys."2.11.9".openmp-sys or false) ||
        (f.imagequant_sys."2.11.9".openmp or false) ||
        (imagequant_sys."2.11.9"."openmp" or false); }
      { "2.11.9".sse =
        (f.imagequant_sys."2.11.9".sse or false) ||
        (f.imagequant_sys."2.11.9".default or false) ||
        (imagequant_sys."2.11.9"."default" or false); }
    ];
    rgb = { "${deps.imagequant_sys."2.11.9".rgb}".default = true; };
  }) [ (features_.rgb."${deps."imagequant_sys"."2.11.9"."rgb"}" deps)
       (features_.cc."${deps."imagequant_sys"."2.11.9"."cc"}" deps) ];
  ...
  crates.libflate."0.1.14" = deps: { features?(features_.libflate."0.1.14" deps {}) }: buildRustCrate {
    crateName = "libflate";
    version = "0.1.14";
    authors = [ "Takeru Ohta <phjgt308@gmail.com>" ];
    sha256 = "03zq769bfffg3iyp2vkkjsmkskabrxiyh5khzppyyngm8w9xpdsc";
    dependencies = mapFeatures features ([ (crates."adler32"."${deps."libflate"."0.1.14"."adler32"}" deps) (crates."byteorder"."${deps."libflate"."0.1.14"."byteorder"}" deps) (crates."crc"."${deps."libflate"."0.1.14"."crc"}" deps) ]);
  };
  features_.libflate."0.1.14" = deps: f: updateFeatures f (rec {
    adler32 = { "${deps.libflate."0.1.14".adler32}".default = true; };
    byteorder = { "${deps.libflate."0.1.14".byteorder}".default = true; };
    crc = { "${deps.libflate."0.1.14".crc}".default = true; };
    libflate = { "0.1.14".default = (f.libflate."0.1.14".default or true); };
  }) [ (features_.adler32."${deps."libflate"."0.1.14"."adler32"}" deps)
       (features_.byteorder."${deps."libflate"."0.1.14"."byteorder"}" deps)
       (features_.crc."${deps."libflate"."0.1.14"."crc"}" deps) ];
  ...
  crates.log."0.4.1" = deps: { features?(features_.log."0.4.1" deps {}) }: buildRustCrate {
    ...
    dependencies = mapFeatures features ([ (crates."cfg_if"."${deps."log"."0.4.1"."cfg_if"}" deps) ]);
  ...
  crates.openssl_sys."0.9.31" = deps: { features?(features_.openssl_sys."0.9.31" deps {}) }: buildRustCrate {
    crateName = "openssl-sys";
    version = "0.9.31";
    authors = [ "Alex Crichton <alex@alexcrichton.com>" "Steven Fackler <sfackler@gmail.com>" ];
    sha256 = "0jqc6ij157z4xfsdrcg4ska7v9i6dlxyl4lnl4di5v716vlxc40c";
    build = "build/main.rs";
    dependencies = mapFeatures features ([ (crates."libc"."${deps."openssl_sys"."0.9.31"."libc"}" deps) ])
      ++ (if abi == "msvc" then mapFeatures features ([]) else []);

    buildDependencies = mapFeatures features ([ (crates."cc"."${deps."openssl_sys"."0.9.31"."cc"}" deps) (crates."pkg_config"."${deps."openssl_sys"."0.9.31"."pkg_config"}" deps) ]);
  };
  features_.openssl_sys."0.9.31" = deps: f: updateFeatures f (rec {
    cc = { "${deps.openssl_sys."0.9.31".cc}".default = true; };
    libc = { "${deps.openssl_sys."0.9.31".libc}".default = true; };
    openssl_sys = { "0.9.31".default = (f.openssl_sys."0.9.31".default or true); };
    pkg_config = { "${deps.openssl_sys."0.9.31".pkg_config}".default = true; };
  }) [ (features_.libc."${deps."openssl_sys"."0.9.31"."libc"}" deps)
       (features_.cc."${deps."openssl_sys"."0.9.31"."cc"}" deps)
       (features_.pkg_config."${deps."openssl_sys"."0.9.31"."pkg_config"}" deps) ];
  ...
  crates.proc_macro2."0.4.4" = deps: { features?(features_.proc_macro2."0.4.4" deps {}) }: buildRustCrate {
    crateName = "proc-macro2";
    version = "0.4.4";
    authors = [ "Alex Crichton <alex@alexcrichton.com>" ];
    sha256 = "1ad1kh0zrwwbvpmgq16fayfga85l06lzffkw0ilfpw5wc3rhrgib";
    dependencies = mapFeatures features ([ (crates."unicode_xid"."${deps."proc_macro2"."0.4.4"."unicode_xid"}" deps) ]);
    features = mkFeatures (features.proc_macro2."0.4.4" or {});
  };
  features_.proc_macro2."0.4.4" = deps: f: updateFeatures f (rec {
    proc_macro2 = fold recursiveUpdate {} [
      { "0.4.4".default = (f.proc_macro2."0.4.4".default or true); }
      { "0.4.4".proc-macro =
        (f.proc_macro2."0.4.4".proc-macro or false) ||
        (f.proc_macro2."0.4.4".default or false) ||
        (proc_macro2."0.4.4"."default" or false) ||
        (f.proc_macro2."0.4.4".nightly or false) ||
        (proc_macro2."0.4.4"."nightly" or false); }
    ];
    unicode_xid = { "${deps.proc_macro2."0.4.4".unicode_xid}".default = true; };
  }) [ (features_.unicode_xid."${deps."proc_macro2"."0.4.4"."unicode_xid"}" deps) ];
  ...
  crates.rand."0.5.0" = deps: { features?(features_.rand."0.5.0" deps {}) }: buildRustCrate {
    ...
    dependencies = mapFeatures features ([ (crates."rand_core"."${deps."rand"."0.5.0"."rand_core"}" deps) ])
      ...
      ++ (if kernel == "windows" then mapFeatures features ([ ]
      ++ (if features.rand."0.5.0".winapi or false then [ (crates.winapi."0.3.4" deps) ] else [])) else [])
  ...
  crates.serde."1.0.65" = deps: { features?(features_.serde."1.0.65" deps {}) }: buildRustCrate {
    crateName = "serde";
    version = "1.0.65";
    authors = [ "Erick Tryzelaar <erick.tryzelaar@gmail.com>" "David Tolnay <dtolnay@gmail.com>" ];
    sha256 = "099nnm4vgansqx71dy1rg9yvbag2wsqkp6kjdy4923yn8wf64myv";
    build = "build.rs";
    dependencies = mapFeatures features ([]);
    features = mkFeatures (features.serde."1.0.65" or {});
  };
  features_.serde."1.0.65" = deps: f: updateFeatures f (rec {
    serde = fold recursiveUpdate {} [
      { "1.0.65".default = (f.serde."1.0.65".default or true); }
      { "1.0.65".serde_derive =
        (f.serde."1.0.65".serde_derive or false) ||
        (f.serde."1.0.65".derive or false) ||
        (serde."1.0.65"."derive" or false); }
      { "1.0.65".std =
        (f.serde."1.0.65".std or false) ||
        (f.serde."1.0.65".default or false) ||
        (serde."1.0.65"."default" or false); }
      { "1.0.65".unstable =
        (f.serde."1.0.65".unstable or false) ||
        (f.serde."1.0.65".alloc or false) ||
        (serde."1.0.65"."alloc" or false); }
    ];
  }) [];


  crates.serde_derive."1.0.65" = deps: { features?(features_.serde_derive."1.0.65" deps {}) }: buildRustCrate {
    crateName = "serde_derive";
    version = "1.0.65";
    authors = [ "Erick Tryzelaar <erick.tryzelaar@gmail.com>" "David Tolnay <dtolnay@gmail.com>" ];
    sha256 = "1bw66p77s498pkhjlp0khypmhdn5ad0947qsifki45wkwhkpzfmp";
    procMacro = true;
    dependencies = mapFeatures features ([ (crates."proc_macro2"."${deps."serde_derive"."1.0.65"."proc_macro2"}" deps) (crates."quote"."${deps."serde_derive"."1.0.65"."quote"}" deps) (crates."syn"."${deps."serde_derive"."1.0.65"."syn"}" deps) ]);
    features = mkFeatures (features.serde_derive."1.0.65" or {});
  };
  features_.serde_derive."1.0.65" = deps: f: updateFeatures f (rec {
    proc_macro2 = { "${deps.serde_derive."1.0.65".proc_macro2}".default = true; };
    quote = { "${deps.serde_derive."1.0.65".quote}".default = true; };
    serde_derive = { "1.0.65".default = (f.serde_derive."1.0.65".default or true); };
    syn = fold recursiveUpdate {} [
      { "${deps.serde_derive."1.0.65".syn}"."visit" = true; }
      { "${deps.serde_derive."1.0.65".syn}".default = true; }
    ];
  }) [ (features_.proc_macro2."${deps."serde_derive"."1.0.65"."proc_macro2"}" deps)
       (features_.quote."${deps."serde_derive"."1.0.65"."quote"}" deps)
       (features_.syn."${deps."serde_derive"."1.0.65"."syn"}" deps) ];


  crates.serde_json."1.0.19" = deps: { features?(features_.serde_json."1.0.19" deps {}) }: buildRustCrate {
    crateName = "serde_json";
    version = "1.0.19";
    authors = [ "Erick Tryzelaar <erick.tryzelaar@gmail.com>" "David Tolnay <dtolnay@gmail.com>" ];
    sha256 = "1k5yirpx51c1850ji8pw1d72razzmjazls7sdwdsw0p4pkl8bxls";
    dependencies = mapFeatures features ([ (crates."dtoa"."${deps."serde_json"."1.0.19"."dtoa"}" deps) (crates."itoa"."${deps."serde_json"."1.0.19"."itoa"}" deps) (crates."serde"."${deps."serde_json"."1.0.19"."serde"}" deps) ]);
    features = mkFeatures (features.serde_json."1.0.19" or {});
  };
  features_.serde_json."1.0.19" = deps: f: updateFeatures f (rec {
    dtoa = { "${deps.serde_json."1.0.19".dtoa}".default = true; };
    itoa = { "${deps.serde_json."1.0.19".itoa}".default = true; };
    serde = { "${deps.serde_json."1.0.19".serde}".default = true; };
    serde_json = fold recursiveUpdate {} [
      { "1.0.19".default = (f.serde_json."1.0.19".default or true); }
      { "1.0.19".linked-hash-map =
        (f.serde_json."1.0.19".linked-hash-map or false) ||
        (f.serde_json."1.0.19".preserve_order or false) ||
        (serde_json."1.0.19"."preserve_order" or false); }
    ];
  }) [ (features_.dtoa."${deps."serde_json"."1.0.19"."dtoa"}" deps)
       (features_.itoa."${deps."serde_json"."1.0.19"."itoa"}" deps)
       (features_.serde."${deps."serde_json"."1.0.19"."serde"}" deps) ];
  ...
  crates.syn."0.14.1" = deps: { features?(features_.syn."0.14.1" deps {}) }: buildRustCrate {
    crateName = "syn";
    version = "0.14.1";
    authors = [ "David Tolnay <dtolnay@gmail.com>" ];
    sha256 = "17qbkd11ljljpwj26xnvmii474wx4xcxkpic836sixa0fmzy0g1b";
    dependencies = mapFeatures features ([ (crates."proc_macro2"."${deps."syn"."0.14.1"."proc_macro2"}" deps) (crates."unicode_xid"."${deps."syn"."0.14.1"."unicode_xid"}" deps) ]
      ++ (if features.syn."0.14.1".quote or false then [ (crates.quote."0.6.3" deps) ] else []));
    features = mkFeatures (features.syn."0.14.1" or {});
  };
  features_.syn."0.14.1" = deps: f: updateFeatures f (rec {
    proc_macro2 = fold recursiveUpdate {} [
      { "${deps.syn."0.14.1".proc_macro2}".default = (f.proc_macro2."${deps.syn."0.14.1".proc_macro2}".default or false); }
      { "0.4.4".proc-macro =
        (f.proc_macro2."0.4.4".proc-macro or false) ||
        (syn."0.14.1"."proc-macro" or false) ||
        (f."syn"."0.14.1"."proc-macro" or false); }
    ];
    quote = fold recursiveUpdate {} [
      { "${deps.syn."0.14.1".quote}".default = (f.quote."${deps.syn."0.14.1".quote}".default or false); }
      { "0.6.3".proc-macro =
        (f.quote."0.6.3".proc-macro or false) ||
        (syn."0.14.1"."proc-macro" or false) ||
        (f."syn"."0.14.1"."proc-macro" or false); }
    ...
    syn = fold recursiveUpdate {} [
      { "0.14.1".clone-impls =
        (f.syn."0.14.1".clone-impls or false) ||
        (f.syn."0.14.1".default or false) ||
        (syn."0.14.1"."default" or false); }
      { "0.14.1".default = (f.syn."0.14.1".default or true); }
      { "0.14.1".derive =
        (f.syn."0.14.1".derive or false) ||
        (f.syn."0.14.1".default or false) ||
        (syn."0.14.1"."default" or false); }
      { "0.14.1".parsing =
        (f.syn."0.14.1".parsing or false) ||
        (f.syn."0.14.1".default or false) ||
        (syn."0.14.1"."default" or false); }
      { "0.14.1".printing =
        (f.syn."0.14.1".printing or false) ||
        (f.syn."0.14.1".default or false) ||
        (syn."0.14.1"."default" or false); }
      { "0.14.1".proc-macro =
        (f.syn."0.14.1".proc-macro or false) ||
        ...
        (syn."0.14.1"."default" or false); }
      { "0.14.1".quote =
        (f.syn."0.14.1".quote or false) ||
        (f.syn."0.14.1".printing or false) ||
        (syn."0.14.1"."printing" or false); }
    ];
    unicode_xid = { "${deps.syn."0.14.1".unicode_xid}".default = true; };
  }) [ (features_.proc_macro2."${deps."syn"."0.14.1"."proc_macro2"}" deps)
       (features_.quote."${deps."syn"."0.14.1"."quote"}" deps)
       (features_.unicode_xid."${deps."syn"."0.14.1"."unicode_xid"}" deps) ];
  ...
  crates.winapi."0.3.4" = deps: { features?(features_.winapi."0.3.4" deps {}) }: buildRustCrate {
    ...
    build = "build.rs";
    dependencies = (if kernel == "i686-pc-windows-gnu" then mapFeatures features ([ (crates."winapi_i686_pc_windows_gnu"."${deps."winapi"."0.3.4"."winapi_i686_pc_windows_gnu"}" deps) ]) else [])
      ++ (if kernel == "x86_64-pc-windows-gnu" then mapFeatures features ([ (crates."winapi_x86_64_pc_windows_gnu"."${deps."winapi"."0.3.4"."winapi_x86_64_pc_windows_gnu"}" deps) ]) else []);
...
rec {
  ...
  deps.imagequant."2.11.9" = {
    imagequant_sys = "2.11.9";
    libc = "0.2.42";
  };
  deps.imagequant_sys."2.11.9" = {
    rgb = "0.8.9";
    cc = "1.0.17";
  };
  deps.imgref."1.3.4" = {};
  ...
  deps.serde."1.0.65" = {};
  deps.serde_derive."1.0.65" = {
    proc_macro2 = "0.4.4";
    quote = "0.6.3";
    syn = "0.14.1";
  };
  deps.serde_json."1.0.19" = {
    dtoa = "0.4.2";
    itoa = "0.4.1";
    serde = "1.0.65";
  };
